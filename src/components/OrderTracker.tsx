...
import { Search, Package, MapPin, Calendar, CreditCard, ChevronRight, Check, AlertTriangle, HelpCircle, RefreshCw } from 'lucide-react';
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                        ...
                        <div className="space-y-2.5">
                          <div className="flex items-center gap-2 text-slate-700">
                            ...
                            <span>
                              <strong>ডেলিভারি ঠিকানা:</strong> {order.name}, {order.village}
                          ...
                          <div className="flex items-center gap-2 text-slate-700">
                            ...
                            <span>
                              পদ্ধতি: <strong>ক্যাশ অন ডেলিভারি (কুরিয়ার মাধ্যমে)</strong>
                            </span>
                          </div>
                        </div>
                      </div>
